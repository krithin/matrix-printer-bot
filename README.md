...
The majority of the code is kept inside of the `matrix_printer_bot` folder, which
...
To run the bot, the `matrix-printer-bot` script in the root of the codebase is
...
the `matrix_printer_bot` directory:
