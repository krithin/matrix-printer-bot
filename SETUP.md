...
You'll notice that "matrix-printer-bot" is scattered throughout the codebase. When
it comes time to modifying the code for your own purposes, you are expected to
replace every instance of "matrix-printer-bot" and its variances with your own
project's name.
...
```
matrix-printer-bot other-config.yaml
```
