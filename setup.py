...
version = exec_file(("matrix_printer_bot", "__init__.py"))["__version__"]
long_description = read_file(("README.md",))


setup(
    name="matrix-printer-bot",
    version=version,
    ...
    # Allow the user to run the bot with `matrix-printer-bot ...`
    scripts=["matrix-printer-bot"],
)
